...
namespace Tools.Text.Xml
{
  ...
  /// </remarks>
  public readonly struct XmlExcapedName : IEquatable<XmlExcapedName>
  {
    private readonly byte[] value;
    private readonly string text;

    private XmlExcapedName(byte[] value)
    {
    ...
    public static XmlExcapedName Encode(string value)
    {
      if (value is null)
      {
      ...
      return new XmlExcapedName(encoded);
    }

    public static XmlExcapedName Encode(ReadOnlySpan<char> value)
    {
      if (value.IsEmpty)
      {
        throw new ArgumentException("The empty text '' is not a valid local name.", nameof(value));
    ...
    public bool Equals(XmlExcapedName other)
    {
      if (value == null)
      {
    ...
    {
      if (obj is XmlExcapedName encodedText)
      {
    ...
    public static bool operator ==(XmlExcapedName left, XmlExcapedName right)
      => left.Equals(right);
