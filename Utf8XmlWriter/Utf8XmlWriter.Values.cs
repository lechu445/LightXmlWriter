...
namespace Tools.Text.Xml
{
  ...
  public sealed partial class Utf8XmlWriter
  {
    ...
    private static ReadOnlySpan<byte> TrueBytes => new byte[] { (byte)'T', (byte)'r', (byte)'u', (byte)'e' };

    private static ReadOnlySpan<byte> FalseBytes => new byte[] { (byte)'F', (byte)'a', (byte)'l', (byte)'s', (byte)'e' };

    public void WriteValue(XmlEncodedValue value)
    {
    ...
    public void WriteValue(char value, bool escape = true)
    {
      ...
      WriteXmlValueString(valueSpan, escape);
    }
