...
namespace Tools.Text.Xml.Tests.Examples
{
  public static class OTA_Standard_XML_Writer_Utf8XmlWriter
  {
    public static void Write(Utf8XmlWriter writer)
    {
    ...
    private static void WriteOtaVehResRQ(Utf8XmlWriter writer)
    {
    ...
    private static void WritePOS(Utf8XmlWriter writer)
    {
    ...
    private static void WriteVehRentalCore(Utf8XmlWriter writer)
    {
    ...
    private static void WriteCustomer(Utf8XmlWriter writer)
    {
    ...
    private static void WriteVendorPref(Utf8XmlWriter writer, string code)
    {
    ...
    private static void WriteVehPref(Utf8XmlWriter writer)
    {
    ...
    private static void WriteRateQualifier(Utf8XmlWriter writer)
    {
    ...
    private static void WriteSpecialEquipPrefs(Utf8XmlWriter writer)
    {
    ...
    private static void WriteArrivalDetails(Utf8XmlWriter writer, string val)
    {
